...
<button class='c-btn' value='Button'>Button</button>

<button class='c-btn c-btn--small' value='Button'>Button</button>

<button class='c-btn c-btn--full' value='Button'>Button</button>